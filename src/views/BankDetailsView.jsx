  ...
  return (
    <div className="space-y-8 sm:space-y-12 py-6 sm:py-8">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#FFFDF9] rounded-3xl p-6 sm:p-8 lg:p-10 border border-emerald-200/80 shadow-sm relative overflow-hidden">
          <div className="relative z-10 max-w-3xl space-y-3">
            <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-200 text-emerald-800 px-3 py-1 rounded-full text-xs font-bold">
              <ShieldCheck className="w-3.5 h-3.5 text-emerald-600" /> Official Verified Bank Accounts • 100% Tax Deductible
            </div>
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <button
                ...
                className="btn-donate-primary text-xs sm:text-sm px-5 py-2.5 rounded-full"
              >
                Donate Online
              </button>
              <button
                onClick={onOpenReceipt}
                className="px-5 py-2.5 bg-white hover:bg-slate-50 text-slate-700 font-bold text-xs sm:text-sm rounded-full border border-slate-300 transition-all flex items-center gap-1.5 shadow-sm"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
          {BANK_ACCOUNTS.map((bank, idx) => (
            ...
            >
              ...
              <div className={`bg-gradient-to-r ${bank.gradient} text-white p-5 relative`}>
                <span className="text-[10px] font-extrabold uppercase tracking-widest bg-white/20 px-2 py-0.5 rounded-full inline-block mb-1.5">
                  {bank.badge}
                </span>
              ...
              {/* Card Body */}
              <div className="p-4 sm:p-5 space-y-3 text-xs sm:text-sm flex-1 flex flex-col justify-between">
                <div className="space-y-2.5">
                  
                  {/* Account Name */}
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100">
                    <span className="text-[10px] text-slate-400 font-bold block uppercase">Account Holder Name</span>
                    <span className="font-bold text-slate-800 text-xs sm:text-sm block mt-0.5">{bank.accountName}</span>
                  </div>
                  ...
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-between">
                    <div>
                      ...
                      <span className="font-mono font-extrabold text-sm sm:text-base text-trust-900">{bank.accountNumber}</span>
                    </div>
                    <button
                      onClick={() => copyText(`acc-${idx}`, bank.accountNumber)}
                      className="p-1.5 bg-white rounded-lg border border-slate-200 text-slate-600 hover:text-trust-600 shadow-sm"
                  ...
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-between">
                    <div>
                      ...
                      <span className="font-mono font-extrabold text-xs sm:text-sm text-slate-800">{bank.ifsc}</span>
                    </div>
                    <button
                  ...
                  {/* Branch */}
                  <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100">
                    <span className="text-[10px] text-slate-400 font-bold block uppercase">Branch Location</span>
                    <span className="font-semibold text-slate-700 text-xs">{bank.branch}</span>
                  </div>

                </div>

                <div className="pt-2 border-t border-slate-100 text-center text-xs font-bold text-emerald-700 flex items-center justify-center gap-1.5">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-trust-50 via-white to-crimson-50/40 border border-trust-200/80 rounded-3xl p-6 sm:p-8 text-center space-y-6 shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-2xl mx-auto">
            ...
            <div className="bg-white p-4 sm:p-5 rounded-3xl shadow-sm border border-slate-200 space-y-3 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-bold text-trust-800 bg-trust-50 px-2.5 py-0.5 rounded-full inline-block">
              ...
              <div className="text-xs text-center pt-1">
                ...
                <span className="font-mono font-bold text-trust-900 text-xs sm:text-sm">riddhisiddhict@hdfcbank</span>
              </div>
            </div>
            ...
            <div className="bg-white p-4 sm:p-5 rounded-3xl shadow-sm border border-slate-200 space-y-3 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-bold text-blue-800 bg-blue-50 px-2.5 py-0.5 rounded-full inline-block">
                    Direct Axis UPI QR
                  </span>
              ...
              <div className="text-xs text-center pt-1">
                ...
                <span className="font-mono font-bold text-trust-900 text-xs sm:text-sm">9820737415@axisbank</span>
              </div>
            </div>
          ...
          <div className="pt-2">
            <button
              onClick={onOpenReceipt}
              className="px-6 py-3 bg-gradient-to-r from-trust-600 to-trust-800 hover:from-trust-700 hover:to-trust-900 text-white font-bold text-xs sm:text-sm rounded-full shadow-md hover:shadow-lg transition-all"
            >
